...
router.route('/clear_fund').options((0, _cors2.default)()).get(_payment.ClearFund);

router.route('/successAndInvoice').options((0, _cors2.default)()).get(_payment.ValidatePayment);
